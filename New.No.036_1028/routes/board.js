const jwt = require("jsonwebtoken"); // jwt 라이브러리를 로드한다.

const router = require("express").Router(); // router를 서버의 라우터로 만든다.

const { User, Board } = require("../models/index.js"); // ./models/index.js를 로드하고 User와 Board에 구조분해 할당한다.
