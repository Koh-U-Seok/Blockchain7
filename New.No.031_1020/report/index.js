...
// url => 주소? 라우터? 서버 내에서 관리하는 파일 위치 등등, 관리하는 내장 모듈
...
//   // 두번째 매개변수는 콜백 함수이며 해당 post 요청에 대해서 처리하는 작업 코드
...
// 접속이 되었을 때 서버는 응답한다.
// URL, 우리가 기존에 생각했던, 알고있던 주소와 지금 얘기하는 주소가 다르다는 것을 알아야 한다.
// 우리가 기존에 알고 있던 주소는 https://search.naver.com/search.naver?where=nexearch&sm=top_hty&fbm=1&ie=utf8&query=qwer
// 서버에서 말하는 주소는 search.naver.com << 도메인 주소를 말한다.
// 라우터 : search.naver
// 쿼리 스트링 : ?where=nexearch&sm=top_hty&fbm=1&ie=utf8&query=qwer
// 우편번호 : 건물마다 결정된다. => 주소
// 정확한 상세 주소 : 라우터
// 도서관 << 주소
// 도서관의 인문학관, 자연학관, 철학관 << 라우터
// 각 관의 책들 << 데이터
// 책들에 들어있는 라벨들을 찾아서 대여한다. << 응답
