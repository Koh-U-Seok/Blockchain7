...
app.post("/transaction/send", (req: Request, res: Response) => {
  // 5-3/6-3 POST 메서드, /transaction/send 라우터로 요 청받음
  ...
  // 5-7/6-7/8-7 생성한 서명과 hash를 만들기 위한 데이터를 가지고 http://localhost:8080/transaction/send에 요청을 보냄
  console.log(
    "5-7/6-7/8-7 생성한 서명과 hash를 만들기 위한 데이터를 가지고 http://localhost:8080/transaction/send에 요청을 보냄"
  );
...
app.post("/block/mine", (req: Request, res: Response) => {
  console.log("7-3 블록 생성 요청을 블록체인 서버에 전달한다.");
