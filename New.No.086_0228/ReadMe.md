...
//  - Windows OS : C:\Users\KGA_19\Desktop\Blockchain7
...
// path.join : 경로를 합쳐서 하나의 문자열로 만든다.

const data = JSON.stringify({
  // solc를 사용하여 솔리디티 코드를 컴파일 시 사용할 설정
  language: "solidity",
  // 언어는 솔리디티다. 솔리디티 이외에도 언어가 있으나 솔리디티가 너무 강해서 다른 언어를 거의 사용하지 않는다. 더 궁금하면 yul 찾아볼 것.
  sources: {
    // 파일에 대한 설정
    "Test.sol": {
