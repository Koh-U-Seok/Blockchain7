...
// app.use(cors());
// CORS 방지 끝. 단, 모든 주소에 대해서 응답해주는 단점이 있다.
app.use(cors({ origin: "http://localhost:3000" }));
// origin은 원본의 주소이며 해당 원본 주소에 대해서만 요청을 응답하겠다.
// - 원본 주소에는 http와 같은 프로토콜, localhost와 같은 Domain 주소, :3000와 같은 포트까지 포함한다.
...
// proxy가 뭔가? 간단히 말하면 중간 서버이다. 중간에서 다른 서버에 자료를 요청해서 자기 것인것 마냥 응답으로 보낸다.
