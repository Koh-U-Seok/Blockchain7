...
const test = async () => {
  ...
  document.getElementById("send").onclick = async () => {
    ...
    console.log("트랜잭션을 보냈다 :", transaction);
    const transaction1 = await web3.eth.getTransaction(
      transaction.transactionHash
    );
    console.log("getTransaction1 : ", transaction1);
  };
  ...
  const transaction = await web3.eth.getTransaction(
    "0x43178f71c07fe4305259f575c1f4d35fb02e970f875e96472943bb0a024c9a44"
  );
  ...
  //     // 트랜잭션을 보낼 시 해당 트랜잭션의 정보를 기준으로 hash를 생성한다.
...
//       params: ["0x5da527da88ca781e6007795172acf4b16734b27e"],
//     },
//   }).then((data) => console.log("new Coinbase : ", data));
// }
// test3();
[
  ...
  "0x01c80ed6f6162210fea2db210275adc206237784",
  "0x1065e3fa7d5c28c3a720c28128e930bae51e9f9a",
  "0xfcea1dac6955d77e65b7220df67c2639a69ce036",
];
