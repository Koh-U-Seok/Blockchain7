...
// import { reducer, initialize } from "counter.js";
...
export const store = configureStore({
  // configureStore는 객체를 매개변수로 받으며 객체 내에서 reducer, middleware 등 필요한 store에 필요한 작업을 할 수 있다.
  reducer: { count: reducer },
  // reducer는 이전의 combineReducer와 같이 객체로 받으며 state명을 키로, 해당 reducer를 값으로 받는다.
