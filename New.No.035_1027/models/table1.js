    ...
    return super.init(
      {
        idx: {
          ...
          primaryKey: true, // 고유 식별 키
          autoIncrement: true, //  idx값 자동 증가
          unique: true, // 값이 중복되면 안된다.
          allowNull: false, // 비면 안된다.
        },
        name: {
          type: Sequelize.STRING(45),
          allowNull: true, // 비면 안된다.
        },
        id: {
          type: Sequelize.STRING(45),
      ...
      },
      {
        ...
        paranoid: false, // 삭제 시 deletedAt을 저장할지, 테이블에서 데이터를 삭제할 시 아예 삭제를 할 것인가? 아니면 삭제한 날짜를 남김으로써 데이터를 남길 것인가?
        charset: "utf8mb4", // 언어 포맷 설정
        collate: "utf8mb4_general_ci", // 언어 포맷 설정
      }
    );
  }
